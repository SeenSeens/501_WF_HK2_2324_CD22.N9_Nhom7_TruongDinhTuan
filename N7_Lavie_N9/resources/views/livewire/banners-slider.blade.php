                    ...
                    <div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 1, &quot;controls&quot;: false, &quot;loop&quot;: false}">
                        <div>
                            <div class="row align-items-center">
                                <div class="col-md-6 order-md-2"><img class="d-block mx-auto" src="frontend/img/home/hero-slider/05.jpg" alt="VR Collection"></div>
                        ...
                        <div>
                            <div class="row align-items-center">
                                <div class="col-md-6 order-md-2"><img class="d-block mx-auto" src="frontend/img/home/hero-slider/04.jpg" alt="VR Collection"></div>
                                <div class="col-lg-5 col-md-6 offset-lg-1 order-md-1 pt-4 pb-md-4 text-center text-md-start">
                        ...
                        <div>
                            <div class="row align-items-center">
                                <div class="col-md-6 order-md-2"><img class="d-block mx-auto" src="frontend/img/home/hero-slider/06.jpg" alt="VR Collection"></div>
                                <div class="col-lg-5 col-md-6 offset-lg-1 order-md-1 pt-4 pb-md-4 text-center text-md-start">
                ...
                <div class="table-responsive" data-simplebar>
                    <div class="d-flex d-xl-block">
                        <a class="d-flex align-items-center bg-faded-info rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style="min-width: 16rem;">
                            <img src="frontend/img/home/banners/banner-sm01.png" width="125" alt="Banner">
                            <div class="py-4 px-2">
                        ...
                        <a class="d-flex align-items-center bg-faded-warning rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style="min-width: 16rem;">
                            <img src="frontend/img/home/banners/banner-sm02.png" width="125" alt="Banner">
                            <div class="py-4 px-2">
                        ...
                        <a class="d-flex align-items-center bg-faded-success rounded-3 pt-2 ps-2 mb-4" href="#" style="min-width: 16rem;">
                            <img src="frontend/img/home/banners/banner-sm03.png" width="125" alt="Banner">
                            <div class="py-4 px-2">
