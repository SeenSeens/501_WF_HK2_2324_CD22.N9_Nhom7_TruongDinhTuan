<main class="container-fluid px-0">
    ...
    <section class="container py-3 py-lg-5 mt-4 mb-3">
        ...
        <div class="row pt-3">
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                <div class="d-flex align-items-center"><img class="rounded-circle" src="frontend/img/team/03.jpg" width="96" alt="Jonathan Doe">
                    <div class="ps-3">
            ...
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                <div class="d-flex align-items-center"><img class="rounded-circle" src="frontend/img/team/04.jpg" width="96" alt="Barbara Palson">
                    <div class="ps-3">
            ...
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                <div class="d-flex align-items-center"><img class="rounded-circle" src="frontend/img/team/06.jpg" width="96" alt="William Smith">
                    <div class="ps-3">
            ...
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                <div class="d-flex align-items-center"><img class="rounded-circle" src="frontend/img/team/02.jpg" width="96" alt="Amanda Gallaher">
                    <div class="ps-3">
            ...
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                <div class="d-flex align-items-center"><img class="rounded-circle" src="frontend/img/team/01.jpg" width="96" alt="Benjamin Miller">
                    <div class="ps-3">
            ...
            <div class="col-lg-4 col-sm-6 mb-grid-gutter">
                <div class="d-flex align-items-center"><img class="rounded-circle" src="frontend/img/team/07.jpg" width="96" alt="Miguel Rodrigez">
                    <div class="ps-3">
    ...
    <hr>
    <section class="row g-0">
        <div class="col-md-6 bg-position-center bg-size-cover bg-secondary order-md-2" style="min-height: 15rem; background-image: url(frontend/img/about/05.jpg);"></div>
        <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
            <div class="mx-auto py-lg-5" style="max-width: 35rem;">
