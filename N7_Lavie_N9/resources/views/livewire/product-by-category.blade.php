<section class="container pt-5">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        <h2 class="h3 mb-0 pt-3 me-2">{{ $selectedCategory ? $selectedCategory->name : 'All Categories' }}</h2>
        ...
        @foreach( $products as $product)
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
                <div class="card product-card">
                    ...
                    <a class="card-img-top d-block overflow-hidden" href="{{ url('/product/'.$product->slug) }}"><img src="{{ asset('/storage/' . $product->thumbnail ) }}" alt="{{ $product->title }}"></a>
                    <div class="card-body py-2">
                        <a class="product-meta d-block fs-xs pb-1" href="{{ url('/product/'.$product->category->slug) }}}">{{ $product->category->name  }}</a>
