<div class="page-content">
    <div class="row">
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    <h6 class="mb-0 text-uppercase text-primary">Thể loại</h6>
                    <hr>
                    <form
                        ...
                        <tbody>
                            @foreach ($types as $type)
                                <tr wire:key="{{ $type->id }}">
                                    ...
                                    <td>{{ $type->slug }}</td>
{{--                                    <td><img src="{{ asset('/storage/' . $type->thumbnail ) }}" class="img-fluid"></td>--}}
                                    <td>
                                        <button class="btn btn-sm btn-light radius-30 text-warning" wire:click="edit({{ $type->id }})"><i class="bx bxs-edit"></i></button>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-light radius-30 text-danger" wire:click="delete({{ $type->id }})" wire:confirm="Bạn chắc chắn muốn xóa"><i class="bx bxs-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
