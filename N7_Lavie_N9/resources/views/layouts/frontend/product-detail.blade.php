        ...
        <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
            ...
            <div class="order-lg-1 pe-lg-4 text-center text-lg-start">
                @if($product_detail)
                    ...
                    <h1 class="h3 text-light mb-2">{{ $product_detail -> title }}</h1>
                    <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 pe-lg-0">
                                <div class="product-gallery">
                                    <div class="product-gallery-thumblist order-sm-1">
                                        ...
                                        <img src="{{ $product_detail ->thumbnail }}" alt="Product thumb">
                                    </div>
                                </div>
                            </div>
                            <!-- Product details-->
                            <div class="col-lg-5 pt-4 pt-lg-0">
                                <div class="product-details ms-auto pb-3">
                                    ...
                                    <div class="h3 fw-normal text-accent mb-3 me-1">${{ $product_detail ->price }}.<small>{{ $product_detail->discount }}</small></div>
